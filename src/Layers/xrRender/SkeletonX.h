...
public:
	...
	void SVP_DiagScope(const Fmatrix& localToWorld, const Fvector& eyeW, const Fvector& axisW, float eyeR, bool dumpBones); // pip temp diag: parent bbox + on-axis/named forward bone scan (objective auto-detect probe)
