...
public:
	bool GetFootStepMatrix(ik_goal_matrix& m, const SCalculateData& cd, const SIKCollideData& cld, bool collide,
	                       bool rotate) const;
...
private:
	...
	ik_goal_matrix::e_collide_state rotate(Fmatrix& xm, const Fplane& p, const Fvector& normal,
	                                       const Fvector& global_point, bool collide) const;

	IC bool make_shift(Fmatrix& xm, const Fvector& cl_point, bool collide, const Fplane& p,
