...
namespace award_system
{
	...
	enum enum_event_operation
	{
		...
		//player predicates
		eo_hit_params,
		//count, weapon_id, bone_id, operation for fly_dist, bullet fly_dist argument
		eo_kill_params,
		//count, weapon_id, bone_id, operation for fly_dist, bullet fly_dist argument
	...
	protected:
		...
		event_condition_t* add_hit_condition_dist(u32 hit_counts, u16 weapon_id, u16 bone_id,
		                                          float_binary_function* fbfunc, float distanse);
		event_condition_t* add_kill_condition_dist(u32 kill_counts, u16 weapon_id, u16 kill_type, u16 special_kill_type,
