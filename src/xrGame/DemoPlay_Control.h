...
public:
	...
	enum EAction
	{
		...
		//ignore param
		on_kill,
		//param contains the name of a killer
		on_die,
		//param contains the name of a victim
		on_artefactdelivering,
		//param contains the name of a player that delivered the art
		on_artefactcapturing,
		//param contains the name of a player that captured the art
