...
void CObjectHandlerPlanner::add_evaluators(CWeapon* weapon)
{
	...
	add_evaluator(uid(id, eWorldPropertyAimed1),
	              xr_new<CObjectPropertyEvaluatorMember>(&m_storage, eWorldPropertyAimed1, true));
	add_evaluator(uid(id, eWorldPropertyAimed2),
	              xr_new<CObjectPropertyEvaluatorMember>(&m_storage, eWorldPropertyAimed2, true));
	add_evaluator(uid(id, eWorldPropertyStrapped),
...
void CObjectHandlerPlanner::add_operators(CWeapon* weapon)
{
	...
	// aim_queue1
	action = xr_new<CObjectActionQueueWait>(weapon, m_object, &m_storage, uid(id, eWorldPropertyQueueWait1),
	                                        "aim_queue1");
	add_condition(action, id, eWorldPropertyHidden, false);
	add_condition(action, id, eWorldPropertySwitch1, true);
	...
	// aim_queue2
	action = xr_new<CObjectActionQueueWait>(weapon, m_object, &m_storage, uid(id, eWorldPropertyQueueWait2),
	                                        "aim_queue2");
	add_condition(action, id, eWorldPropertyHidden, false);
	add_condition(action, id, eWorldPropertySwitch1, true);
	...
	// fire no reload
	action = xr_new<CObjectActionFireNoReload>(weapon, m_object, &m_storage, uid(id, eWorldPropertyQueueWait1),
	                                           "fire_no_reload");
	add_condition(action, id, eWorldPropertyHidden, false);
	//	add_condition		(action,id,eWorldPropertyEmpty1,	false);
	//	add_condition		(action,id,eWorldPropertyAimed1,	true);
	...
	this->action(uid(id, eWorldOperatorAim1)).set_inertia_time(250);
	this->action(uid(id, eWorldOperatorAim2)).set_inertia_time(250);
	this->action(uid(id, eWorldOperatorAimingReady1)).set_inertia_time(250);
	this->action(uid(id, eWorldOperatorAimingReady2)).set_inertia_time(250);
	this->action(uid(id, eWorldOperatorAimForceFull1)).set_inertia_time(250);
	this->action(uid(id, eWorldOperatorAimForceFull2)).set_inertia_time(250);
