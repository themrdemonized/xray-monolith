...
public:
	...
	void PrepareToReceiveFile(ClientID const& from_client, shared_str const& client_session_id,
	...
	struct fr_callback_binder
	{
		...
		void __stdcall receiving_file_callback(file_transfer::receiving_status_t status, u32 bytes_received,
		                                       u32 data_size);
		void __stdcall receiving_serverinfo_callback(file_transfer::receiving_status_t status, u32 bytes_received,
		                                             u32 data_size);
	};
