...
void CStalkerSearchPlanner::add_evaluators()
{
	...
	add_evaluator(eWorldPropertyEnemyLocationReached,
	              xr_new<CStalkerPropertyEvaluatorMember>((CPropertyStorage*)0, eWorldPropertyEnemyLocationReached,
	                                                      true, true, "enemy location reached"));
	add_evaluator(eWorldPropertyAmbushLocationReached,
	              xr_new<CStalkerPropertyEvaluatorMember>((CPropertyStorage*)0, eWorldPropertyAmbushLocationReached,
	                                                      true, true, "ambush location reached"));
}
...
void CStalkerSearchPlanner::add_actions()
{
	...
	action = xr_new<CStalkerActionReachEnemyLocation>(m_object, CActionBase<CScriptGameObject>::m_storage,
	                                                  "reach enemy location");
	...
	action = xr_new<CStalkerActionReachAmbushLocation>(m_object, CActionBase<CScriptGameObject>::m_storage,
	                                                   "reach ambush location");
	...
	action = xr_new<CStalkerActionHoldAmbushLocation>(m_object, CActionBase<CScriptGameObject>::m_storage,
	                                                  "hold ambush location");
