...
{
	planner().set_goal(object_action, game_object, min_queue_size, max_queue_size, min_queue_interval,
	                   max_queue_interval);
}
...
bool CObjectHandler::weapon_strapped(CWeapon* weapon) const
{
	...
	bool const almost_strapped = planner().current_action_state_id() == ObjectHandlerSpace::
...
bool CObjectHandler::weapon_unstrapped(CWeapon* weapon) const
{
	...
	bool const almost_unstrapped = planner().current_action_state_id() == ObjectHandlerSpace::
