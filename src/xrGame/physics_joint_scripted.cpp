...
void cphysics_joint_scripted::script_register(lua_State* L)
{
	...
	[
		...
		.def("set_anchor_global",
		     (void(cphysics_joint_scripted::*)(const float, const float, const float))(&cphysics_joint_scripted::
			     SetAnchor))
		.def("set_anchor_vs_first_element",
		     (void(cphysics_joint_scripted::*)(const float, const float, const float))(&cphysics_joint_scripted::
			     SetAnchorVsFirstElement))
		.def("set_anchor_vs_second_element",
		     (void(cphysics_joint_scripted::*)(const float, const float, const float))(&cphysics_joint_scripted::
			     SetAnchorVsSecondElement))
		...
		.def("set_axis_dir_global",
		     (void(cphysics_joint_scripted::*)(const float, const float, const float, const int))(&
			     cphysics_joint_scripted::SetAxisDir))
		.def("set_axis_dir_vs_first_element",
		     (void(cphysics_joint_scripted::*)(const float, const float, const float, const int))(&
			     cphysics_joint_scripted::SetAxisDirVsFirstElement))
		.def("set_axis_dir_vs_second_element",
		     (void(cphysics_joint_scripted::*)(const float, const float, const float, const int))(&
			     cphysics_joint_scripted::SetAxisDirVsSecondElement))
