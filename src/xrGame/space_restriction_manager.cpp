...
void CSpaceRestrictionManager::add_restrictions(ALife::_OBJECT_ID id, shared_str add_out_restrictions,
...
void CSpaceRestrictionManager::remove_restrictions(ALife::_OBJECT_ID id, shared_str remove_out_restrictions,
...
void CSpaceRestrictionManager::change_restrictions(ALife::_OBJECT_ID id, shared_str add_out_restrictions,
                                                   shared_str add_in_restrictions, shared_str remove_out_restrictions,
                                                   shared_str remove_in_restrictions)
{
	CRestrictionPtr _client_restriction = restriction(id);
	if (!_client_restriction)
