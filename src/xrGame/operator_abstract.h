...
public:
	...
	template <typename T>
	IC bool applicable(const CSConditionState& condition, const CSConditionState& start,
	...
	template <typename T>
	IC const CSConditionState& apply(const CSConditionState& condition, const CSConditionState& self_condition,
