...
bool stalker_movement_manager_smart_cover::in_range(shared_str const& cover_id, shared_str const& loophole_id,
...
bool stalker_movement_manager_smart_cover::in_min_acceptable_range(shared_str const& cover_id,
                                                                   shared_str const& loophole_id,
