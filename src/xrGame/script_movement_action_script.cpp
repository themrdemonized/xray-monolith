...
void CScriptMovementAction::script_register(lua_State* L)
{
	...
	[
		...
		.def(constructor<MonsterSpace::EBodyState, MonsterSpace::EMovementType, DetailPathManager::EDetailPathType,
		                 CScriptGameObject*>())
		.def(constructor<MonsterSpace::EBodyState, MonsterSpace::EMovementType, DetailPathManager::EDetailPathType,
		...
		>())
		.def(constructor<MonsterSpace::EScriptMonsterMoveAction, CPatrolPathParams*, float, MonsterSpace::
		                 EScriptMonsterSpeedParam>())
		.def(constructor<MonsterSpace::EScriptMonsterMoveAction, CScriptGameObject*, float, MonsterSpace::
		                 EScriptMonsterSpeedParam>())
