...
namespace award_system
{
	...
	void reward_event_generator::OnBullet_Fire(u16 sender, u16 sender_weapon_id, const Fvector& position,
	...
	void reward_event_generator::OnBullet_Hit(CObject const* hitter, CObject const* victim, CObject* weapon,
	                                          u16 const bone)
	{
	...
	void reward_event_generator::OnPlayerKilled(u16 killer_id, u16 target_id, u16 weapon_id,
