...
void CUIMpServerAdm::Init(CUIXml& xml_doc)
{
	...
	CUIXmlInit::Init3tButton(xml_doc, "server_adm:main_selection_wnd:change_game_limits_button", 0,
	                         m_pChangeGameLimitsBtn);
	...
	CUIXmlInit::InitSpin(xml_doc, "server_adm:weather_selection_wnd:weather_change_rate_spin", 0,
	                     m_pWeatherChangeRateSpin);
	CUIXmlInit::Init3tButton(xml_doc, "server_adm:weather_selection_wnd:set_weather_rate_button", 0,
	                         m_pWeatherChangeRateBtn);
	...
	CUIXmlInit::InitEditBox(xml_doc, "server_adm:game_limits_selection_wnd:invincible_time_edit", 0,
	                        m_pInvincibleTimeEdit);
	CUIXmlInit::Init3tButton(xml_doc, "server_adm:game_limits_selection_wnd:invincible_time_button", 0,
	                         m_pSetInvincibleTimeBtn);
	CUIXmlInit::InitEditBox(xml_doc, "server_adm:game_limits_selection_wnd:damage_block_time_edit", 0,
	                        m_pDamageBlockTimeEdit);
	CUIXmlInit::Init3tButton(xml_doc, "server_adm:game_limits_selection_wnd:damage_block_time_button", 0,
	                         m_pSetDamageBlockTimeBtn);
	CUIXmlInit::InitEditBox(xml_doc, "server_adm:game_limits_selection_wnd:reinforcement_time_edit", 0,
	                        m_pReinforcementTimeEdit);
	CUIXmlInit::Init3tButton(xml_doc, "server_adm:game_limits_selection_wnd:reinforcement_time_button", 0,
	                         m_pSetReinforcementTimeBtn);
	CUIXmlInit::InitCheck(xml_doc, "server_adm:game_limits_selection_wnd:vote_enabled_check", 0, m_pVoteEnabledCheck);
	CUIXmlInit::InitCheck(xml_doc, "server_adm:game_limits_selection_wnd:dam_block_indic_check", 0,
	                      m_pDamBlockIndicCheck);
	CUIXmlInit::InitCheck(xml_doc, "server_adm:game_limits_selection_wnd:friendly_names_check", 0,
	                      m_pFriendlyNamesCheck);
	CUIXmlInit::InitCheck(xml_doc, "server_adm:game_limits_selection_wnd:friendly_indic_check", 0,
	                      m_pFriendlyIndicCheck);
	CUIXmlInit::InitCheck(xml_doc, "server_adm:game_limits_selection_wnd:bearer_cant_sprint_check", 0,
	                      m_pBearerCantSprintCheck);
