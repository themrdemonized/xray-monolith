...
void CScriptActionPlanner::script_register(lua_State* L)
{
	...
	[
		...
		.def("remove_action",
		     (void (CScriptActionPlanner::*)(const CScriptActionPlanner::_edge_type&))(&CScriptActionPlanner::
			     remove_operator))
		.def("action", &CScriptActionPlanner::action)
		.def("add_evaluator", &CScriptActionPlanner::add_evaluator, adopt(_3))
		.def("remove_evaluator",
		     (void (CScriptActionPlanner::*)(const CScriptActionPlanner::_condition_type&))(&CScriptActionPlanner::
			     remove_evaluator))
