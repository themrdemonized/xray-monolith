...
protected:
	...
	virtual void SendPlayerKilledMessage(u16 KilledID, KILL_TYPE KillType, u16 KillerID, u16 WeaponID,
	...
	void ChargeGrenades(CSE_ALifeItemWeapon* weapon, LPCSTR grenades_string,
...
protected:
	...
	virtual void OnPlayerOpenBuyMenu(xrClientData const* pclient)
	{
	}; //this method invokes only if player dead
