...
void CStalkerAnimationPair::play_global_animation(IKinematicsAnimated* skeleton_animated, PlayCallback callback,
                                                  const u32& bone_part, const bool& use_animation_movement_control,
                                                  const bool& local_animation, bool mix_animations)
#endif
{
	//DBG_OpenCashedDraw();
...
void CStalkerAnimationPair::play(IKinematicsAnimated* skeleton_animated, PlayCallback callback,
                                 ...
                                 bool continue_interrupted_animation, const u32& bone_part, bool mix_animations)
#endif
{
	VERIFY(animation());
	if (actual())
...
#else
		play_global_animation(skeleton_animated, callback, bone_part, use_animation_movement_control, local_animation,
		                      mix_animations);
#endif
	m_actual = true;
...
bool CStalkerAnimationPair::use_animation_movement_control(IKinematicsAnimated* skeleton_animated,
