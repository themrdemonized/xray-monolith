                                         ...
                                         const xr_vector<ALife::_OBJECT_ID>& in_restrictions)
{
	...
	START_PROFILE("Restricted Object/Add Restrictions")
		...
		Level().space_restriction_manager().
		        add_restrictions(object().ID(), temp_out_restrictions, temp_in_restrictions);
                                            ...
                                            const xr_vector<ALife::_OBJECT_ID>& in_restrictions)
{
	...
	START_PROFILE("Restricted Object/Remove Restrictions")
		...
		Level().space_restriction_manager().remove_restrictions(object().ID(), temp_out_restrictions,
		                                                        temp_in_restrictions);
...
void CRestrictedObject::remove_all_restrictions()
{
	START_PROFILE("Restricted Object/Remove Restrictions")
		...
		if (Level().space_restriction_manager().in_restrictions(object().ID()).size() || Level()
		                                                                                 .space_restriction_manager().
		                                                                                 out_restrictions(object().ID())
		                                                                                 .size())
			actual(false);
