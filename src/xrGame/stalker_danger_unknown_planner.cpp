...
void CStalkerDangerUnknownPlanner::add_evaluators()
{
	...
	add_evaluator(eWorldPropertyCoverReached,
	              xr_new<CStalkerPropertyEvaluatorMember>((CPropertyStorage*)0, eWorldPropertyCoverReached, true, true,
	                                                      "danger unknown : cover reached"));
	add_evaluator(eWorldPropertyLookedAround,
	              xr_new<CStalkerPropertyEvaluatorMember>((CPropertyStorage*)0, eWorldPropertyLookedAround, true, true,
	                                                      "danger unknown : looked around"));
}
