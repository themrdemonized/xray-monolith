...
namespace award_system
{
	...
	void rewarding_event_handlers::OnBullet_Fire(u16 sender, u16 sender_weapon_id, const Fvector& position,
	...
	void rewarding_event_handlers::OnBullet_Hit(CObject const* hitter, CObject const* victim, CObject const* weapon,
	                                            u16 const bone)
	{
		for (handlers_store_t::iterator i = m_events_store.begin(),
		                                ie = m_events_store.end(); i != ie; ++i)
	...
	void rewarding_event_handlers::OnPlayerKilled(u16 killer_id, u16 target_id, u16 weapon_id,
