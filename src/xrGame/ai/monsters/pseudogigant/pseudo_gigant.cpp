...
void CPseudoGigant::Load(LPCSTR section)
{
	...
	anim().AddAnim(eAnimSitIdle, "sit_idle_", -1, &velocity_none, PS_SIT, "fx_stand_f", "fx_stand_b", "fx_stand_l",
	               "fx_stand_r");
	anim().AddAnim(eAnimSleep, "stand_sleep_", -1, &velocity_none, PS_LIE, "fx_stand_f", "fx_stand_b", "fx_stand_l",
	               "fx_stand_r");
	...
	anim().AddAnim(eAnimRunDamaged, "stand_walk_fwd_dmg_", -1, &velocity_walk_dmg, PS_STAND, "fx_stand_f", "fx_stand_b",
	               "fx_stand_l", "fx_stand_r");
	anim().AddAnim(eAnimEat, "stand_eat_", -1, &velocity_none, PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
	               "fx_stand_r");
	...
	anim().AddAnim(eAnimSteal, "stand_steal_", -1, &velocity_steal, PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
	               "fx_stand_r");
	anim().AddAnim(eAnimDie, "stand_idle_", -1, &velocity_none, PS_STAND, "fx_stand_f", "fx_stand_b", "fx_stand_l",
	               "fx_stand_r");
	...
	::Sound->create(m_sound_threaten_hit, pSettings->r_string(section, "sound_threaten_hit"), st_Effect,
	                SOUND_TYPE_WORLD);
...
void CPseudoGigant::on_threaten_execute()
{
	...
	// запустить эффектор
	Actor()->Cameras().AddCamEffector(xr_new<CMonsterEffectorHit>(m_threaten_effector.ce_time,
	                                                              m_threaten_effector.ce_amplitude * hit_value,
	                                                              m_threaten_effector.ce_period_number,
	...
	Actor()->Cameras().AddPPEffector(xr_new<CMonsterEffector>(m_threaten_effector.ppi, m_threaten_effector.time,
	                                                          m_threaten_effector.time_attack,
