...
void CAI_Stalker::script_register(lua_State* L)
{
	...
	[
		...
		[
			...
			luabind::value("property_enemy_critically_wounded",
			               StalkerDecisionSpace::eWorldPropertyEnemyCriticallyWounded),
		...
		[
			...
			luabind::value("action_communicate_with_customer",
			               StalkerDecisionSpace::eWorldOperatorCommunicateWithCustomer),
			...
			luabind::value("action_kill_if_player_on_the_path",
			               StalkerDecisionSpace::eWorldOperatorKillEnemyIfPlayerOnThePath),
			...
			luabind::value("action_danger_in_direction_planner",
			               StalkerDecisionSpace::eWorldOperatorDangerInDirectionPlanner),
			...
			luabind::value("action_danger_unknown_take_cover",
			               StalkerDecisionSpace::eWorldOperatorDangerUnknownTakeCover),
			luabind::value("action_danger_unknown_look_around",
			               StalkerDecisionSpace::eWorldOperatorDangerUnknownLookAround),
			luabind::value("action_danger_unknown_search",
			               StalkerDecisionSpace::eWorldOperatorDangerUnknownSearchEnemy),

			luabind::value("action_danger_in_direction_take_cover",
			               StalkerDecisionSpace::eWorldOperatorDangerInDirectionTakeCover),
			luabind::value("action_danger_in_direction_look_out",
			               StalkerDecisionSpace::eWorldOperatorDangerInDirectionLookOut),
			luabind::value("action_danger_in_direction_hold_position",
			               StalkerDecisionSpace::eWorldOperatorDangerInDirectionHoldPosition),
			luabind::value("action_danger_in_direction_detour",
			               StalkerDecisionSpace::eWorldOperatorDangerInDirectionDetourEnemy),
			luabind::value("action_danger_in_direction_search",
			               StalkerDecisionSpace::eWorldOperatorDangerInDirectionSearchEnemy),

			luabind::value("action_danger_grenade_take_cover",
			               StalkerDecisionSpace::eWorldOperatorDangerGrenadeTakeCover),
			luabind::value("action_danger_grenade_wait_for_explosion",
			               StalkerDecisionSpace::eWorldOperatorDangerGrenadeWaitForExplosion),
			luabind::value("action_danger_grenade_take_cover_after_explosion",
			               StalkerDecisionSpace::eWorldOperatorDangerGrenadeTakeCoverAfterExplosion),
			luabind::value("action_danger_grenade_look_around",
			               StalkerDecisionSpace::eWorldOperatorDangerGrenadeLookAround),
		...
		[
			...
			luabind::value("sound_attack_allies_several_enemies",
			               StalkerSpace::eStalkerSoundAttackAlliesSeveralEnemies),
