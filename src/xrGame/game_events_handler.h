...
namespace award_system
{
	...
	public:
		...
		virtual void OnBullet_Fire(u16 sender, u16 sender_weapon_id, const Fvector& position,
		                           const Fvector& direction) = 0;
		virtual void OnBullet_Hit(CObject const* hitter, CObject const* victim, CObject const* weapon,
		                          u16 const bone) = 0;
		...
		virtual void OnPlayerKilled(u16 killer_id, u16 target_id, u16 weapon_id,
