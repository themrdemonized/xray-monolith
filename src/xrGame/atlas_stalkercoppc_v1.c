...
int ATLAS_GET_STAT_PAGE_BY_NAME(char* statName)
{
	...
	if (!strcmp("STAT_AwardAchillesHeel", statName) || !strcmp("STAT_AwardAchillesHeelLastRewardDate", statName) ||
		...
		!strcmp("STAT_AwardDoubleShotDoubleKill", statName) || !strcmp("STAT_AwardDoubleShotDoubleKillLastRewardDate",
		                                                               statName) ||
		!strcmp("STAT_AwardDryVictory", statName) || !strcmp("STAT_AwardDryVictoryLastRewardDate", statName) ||
		!strcmp("STAT_AwardFasterThanBullets", statName) || !strcmp("STAT_AwardFasterThanBulletsLastRewardDate",
		                                                            statName) ||
		...
		!strcmp("STAT_AwardOwerwhelmingSuperiority", statName) || !strcmp(
			"STAT_AwardOwerwhelmingSuperiorityLastRewardDate", statName) ||
