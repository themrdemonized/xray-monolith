...
void CUIGameCustom::script_register(lua_State* L)
{
	...
	[
        ...
        .def("RemoveCustomShapeToRender", &CUIGameCustom::RemoveCustomShapeToRender)
        .def("HasCustomShape", &CUIGameCustom::HasCustomShape)
        .def("UpdateCustomShape", &CUIGameCustom::UpdateCustomShape)
