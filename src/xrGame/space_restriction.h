...
private:
	...
	IC bool intersects(SpaceRestrictionHolder::CBaseRestrictionPtr bridge0,
...
public:
	CSpaceRestriction(CSpaceRestrictionManager* space_restriction_manager, shared_str out_restrictions,
