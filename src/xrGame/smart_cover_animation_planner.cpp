...
void animation_planner::add_actions()
{
	...
	action = xr_new<idle_2_lookout_transition>(m_object, "idle_2_lookout", "idle", "lookout", eWorldPropertyReadyToIdle,
	                                           eWorldPropertyReadyToLookout, this);
	add_condition(action, eWorldPropertySmartCoverActual, true);
	add_condition(action, eWorldPropertySmartCoverEntered, true);
	add_condition(action, eWorldPropertyLoopholeActual, true);
	add_condition(action, eWorldPropertyReadyToIdle, true);
	...
	action = xr_new<lookout_2_idle_transition>(m_object, "lookout_2_idle", "lookout", "idle",
	                                           eWorldPropertyReadyToLookout, eWorldPropertyReadyToIdle, this);
	add_condition(action, eWorldPropertySmartCoverEntered, true);
	add_condition(action, eWorldPropertyReadyToLookout, true);
	...
	action = xr_new<idle_2_fire_transition>(m_object, "idle_2_fire", "idle", "fire", eWorldPropertyReadyToIdle,
	                                        eWorldPropertyReadyToFire, this, true);
	add_condition(action, eWorldPropertySmartCoverActual, true);
	add_condition(action, eWorldPropertySmartCoverEntered, true);
	add_condition(action, eWorldPropertyLoopholeActual, true);
	add_condition(action, eWorldPropertyReadyToIdle, true);
	...
	action = xr_new<fire_2_idle_transition>(m_object, "fire_2_idle", "fire", "idle", eWorldPropertyReadyToFire,
	...
	action = xr_new<idle_2_fire_transition>(m_object, "idle_2_fire_no_lookout", "idle", "fire_no_lookout",
	...
	action = xr_new<fire_2_idle_transition>(m_object, "fire_no_lookout_2_idle", "fire_no_lookout", "idle",
