...
private:
	...
	// fov range checks
private:
	bool in_min_acceptable_range(shared_str const& cover_id, shared_str const& loophole_id, Fvector const& position,
...
private:
	void loophole_path(smart_cover::cover const& cover, shared_str const& source, shared_str const& target,
