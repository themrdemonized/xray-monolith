...
const float start_fire_angle_difference = g_alife_combat_overhaul ? PI_DIV_3 : PI_DIV_8; // SkyKi: Increased from PI_DIV_8 (22.5 deg) to PI_DIV_3 (60 deg) for faster reaction times
