...
IC CScriptWatchAction::CScriptWatchAction(SightManager::ESightType tWatchType, CScriptGameObject* tpObjectToWatch,
...
CScriptWatchAction(const Fvector& tTarget, float vel1, float vel2) : m_tWatchType(), m_tGoalType()
{
	m_tpObjectToWatch = 0;
