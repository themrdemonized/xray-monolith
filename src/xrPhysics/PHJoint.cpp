...
void CPHJoint::CreateBall()
{
	...
	switch (vs_anchor)
	{
	case vs_first: first_matrix.transform_tiny(pos, anchor);
		break;
	case vs_second: second_matrix.transform_tiny(pos, anchor);
		break;
	case vs_global: pShell->mXFORM.transform_tiny(pos, anchor);
		break;
	default: NODEFAULT;
	}
...
void CPHJoint::SetAxisDirDynamic(const Fvector& orientation, const int axis_num)
{
	...
	case hinge2:
		switch (axis_num)
		{
		case 0: dJointSetHinge2Axis1(m_joint, orientation[0], orientation[1], orientation[2]);
			break;
		case 1: dJointSetHinge2Axis2(m_joint, orientation[0], orientation[1], orientation[2]);
			break;
		default: NODEFAULT;
		}
		break;
	case slider:
		switch (axis_num)
		{
		case 0: dJointSetSliderParam(m_joint, dParamFMax, axes[0].force);
			break;
		case 1: dJointSetAMotorParam(m_joint1, dParamFMax, axes[1].force);
			break;
		default: NODEFAULT;
		}
		break;
...
void CPHJoint::SetLimits(const float low, const float high, const int axis_num)
{
	...
	switch (axes[ax].vs)
	{
	case vs_first: pFirst_element->mXFORM.transform_dir(axis, axes[ax].direction);
		break;
	case vs_second: pSecond_element->mXFORM.transform_dir(axis, axes[ax].direction);
		break;
	case vs_global:
...
void CPHJoint::Create()
{
	...
	case ball: CreateBall();
		break;
	case hinge: CreateHinge();
		break;
	case hinge2: CreateHinge2();
		break;
	case full_control: CreateFullControl();
		break;
...
void CPHJoint::SetForceActive(const int axis_num)
{
	...
	case hinge2: switch (axis_num)
		...
		case -1:
			dJointSetHinge2Param(m_joint, dParamFMax, axes[0].force);
			dJointSetHinge2Param(m_joint, dParamFMax2, axes[1].force);
		case 0: dJointSetHinge2Param(m_joint, dParamFMax, axes[0].force);
			break;
		case 1: dJointSetHinge2Param(m_joint, dParamFMax2, axes[1].force);
			break;
		}
		break;
	...
	case full_control:
		...
		case -1:
			...
			dJointSetAMotorParam(m_joint1, dParamFMax2, axes[1].force);
			dJointSetAMotorParam(m_joint1, dParamFMax3, axes[2].force);
		case 0: dJointSetAMotorParam(m_joint1, dParamFMax, axes[0].force);
			break;
		case 1: dJointSetAMotorParam(m_joint1, dParamFMax2, axes[1].force);
			break;
		case 2: dJointSetAMotorParam(m_joint1, dParamFMax3, axes[2].force);
			break;
		}
		break;
	}
...
void CPHJoint::SetVelocityActive(const int axis_num)
{
	...
	case hinge2: switch (axis_num)
		...
		case -1:
			dJointSetHinge2Param(m_joint, dParamVel, axes[0].velocity);
			dJointSetHinge2Param(m_joint, dParamVel2, axes[1].velocity);
		case 0: dJointSetHinge2Param(m_joint, dParamVel, axes[0].velocity);
			break;
		case 1: dJointSetHinge2Param(m_joint, dParamVel2, axes[1].velocity);
			break;
		}
		break;
	case slider: switch (axis_num)
		...
		case -1:
			dJointSetSliderParam(m_joint, dParamVel, axes[0].velocity);
			dJointSetAMotorParam(m_joint1, dParamVel, axes[1].velocity);
		case 0: dJointSetSliderParam(m_joint, dParamVel, axes[0].velocity);
			break;
		case 1: dJointSetAMotorParam(m_joint1, dParamVel, axes[1].velocity);
			break;
		}
		break;
	case ball: break;
	...
	case full_control:
		...
		case -1:
			...
			dJointSetAMotorParam(m_joint1, dParamVel2, axes[1].velocity);
			dJointSetAMotorParam(m_joint1, dParamVel3, axes[2].velocity);
		case 0: dJointSetAMotorParam(m_joint1, dParamVel, axes[0].velocity);
			break;
		case 1: dJointSetAMotorParam(m_joint1, dParamVel2, axes[1].velocity);
			break;
		case 2: dJointSetAMotorParam(m_joint1, dParamVel3, axes[2].velocity);
			break;
		}
		break;
	}
...
float CPHJoint::GetAxisAngle(int axis_num)
{
	...
	switch (eType)
	{
	case hinge2: ret = dJointGetHinge2Angle1(m_joint);
		break;
	case ball: ret = dInfinity;
		break;
	case hinge: ret = dJointGetHingeAngle(m_joint);
		break;
	case full_control: ret = dJointGetAMotorAngle(m_joint1, axis_num);
		break;
	case slider:
		switch (axis_num)
		{
		case 0: ret = dJointGetSliderPosition(m_joint);
			break;
		case 1: ret = dJointGetAMotorAngle(m_joint1, 0);
			break;
		};
		break;
	default: R_ASSERT2(false, "type not supported");
...
void CPHJoint::SetJointSDfactorsActive()
{
	...
	case hinge2: dJointSetHinge2Param(m_joint, dParamSuspensionERP, m_erp);
		...
		break ;
	case ball: break ;
	case hinge: dJointSetHingeParam(m_joint, dParamCFM, m_cfm);
		break ;
	case full_control: dJointSetAMotorParam(m_joint1, dParamCFM, m_cfm);
		dJointSetAMotorParam(m_joint1, dParamCFM2, m_cfm);
		dJointSetAMotorParam(m_joint1, dParamCFM3, m_cfm);
		break ;
	case slider: dJointSetSliderParam(m_joint, dParamCFM, m_cfm);
		break ;
	}
}
                        ...
                        const Fmatrix& second_matrix, const Fmatrix& rotate)
{
	...
	{
	case vs_first: first_matrix.transform_dir(axis, axes[ax_num].direction);
		break;
	case vs_second: second_matrix.transform_dir(axis, axes[ax_num].direction);
		break;
	case vs_global: pShell->mXFORM.transform_dir(axis, axes[ax_num].direction);
		break;
	default: NODEFAULT;
	}
	lo = axes[ax_num].low;
