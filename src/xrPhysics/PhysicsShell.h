...
public:
	...
	virtual void applyImpulseTrace(const Fvector& pos, const Fvector& dir, float val, const u16 id) = 0;
	virtual void applyHit(const Fvector& pos, const Fvector& dir, float val, const u16 id,
	                      ALife::EHitType hit_type) = 0;
...
XRPHYSICS_API CPhysicsJoint* P_create_Joint(CPhysicsJoint::enumType type, CPhysicsElement* first,
...
XRPHYSICS_API CPhysicsShell* P_build_Shell(IPhysicsShellHolder* obj, bool not_active_state, BONE_P_MAP* bone_map,
                                           LPCSTR fixed_bones);

extern "C" XRPHYSICS_API CPhysicsShell* __stdcall P_build_Shell(IPhysicsShellHolder* obj, bool not_active_state,
                                                                BONE_P_MAP* bone_map = 0,
                                                                bool not_set_bone_callbacks = false);
