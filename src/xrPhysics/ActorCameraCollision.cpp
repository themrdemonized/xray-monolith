...
static void cammera_shell_collide_callback_common(bool& do_collide, bool bo1, dContact& c, SGameMtl* material_1,
                                                  SGameMtl* material_2)
{
	if (!do_collide)
		return;
	...
	//dJointCreateContact(0, ContactGroup, &c);//
...
static void cammera_shell_collide_callback(bool& do_collide, bool bo1, dContact& c, SGameMtl* material_1,
                                           SGameMtl* material_2)
{
...
static void cammera_shell_character_collide_callback(bool& do_collide, bool bo1, dContact& c, SGameMtl* material_1,
                                                     SGameMtl* material_2)
{
	dxGeomUserData* oposite_data = retrieveGeomUserData(bo1 ? c.geom.g2 : c.geom.g1);
	do_collide = false;
...
void set_camera_collision(const Fvector& box_size, const Fmatrix& xform, CPhysicsElement* roote, CBoxGeom* box)
{
	...
	character_collision_geom_local_xform.c.set(
		Fvector().mul(character_collision_geom_local_xform.j,
		              -camera_collision_character_gl_shift_y).add(
...
void do_collide_and_move(const Fmatrix& xform, IPhysicsShellHolder* l_actor, CPhysicsShell* shell,
                         CPhysicsElement* roote)
{
	///////////////////////////////////////////////////////////////////
	VERIFY(ph_world);
...
bool do_collide_not_move(const Fmatrix& xform, IPhysicsShellHolder* l_actor, CPhysicsShell* shell,
                         CPhysicsElement* roote)
{
	///////////////////////////////////////////////////////////////////
	VERIFY(ph_world);
