...
void export_classes	(lua_State *L)
{
	...
	ScriptImGui::script_register(L);
	ScriptLight::script_register(L);
	CScriptWallmarksManager::script_register(L);
	CUIActorMenu::script_register(L);
	//UIHintWindow::script_register(L);
