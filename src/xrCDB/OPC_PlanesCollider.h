...
public:
	...
	inline_ bool Collide(PlanesCache& cache, const OBB& box, OPCODE_Model* model, const Matrix4x4* worldb = null,
	                     const Matrix4x4* worldm = null)
	{
		Plane PL[6];
...
protected:
	...
	// Overlap tests
	inline_ BOOL PlanesAABBOverlap(const Point& center, const Point& extents, udword& out_clip_mask,
	                               udword in_clip_mask);
