...
TEMPLATE_SPECIALIZATION
inline buffer_vector_specialized::buffer_vector(void* buffer, size_type const& max_count, size_type const& count,
...
inline buffer_vector_specialized::buffer_vector(void* buffer, size_type const& max_count, input_iterator const& begin,
