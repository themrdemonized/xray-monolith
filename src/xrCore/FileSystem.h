...
public:
    ...
    void ExtractFileName(LPCSTR src, LPSTR dest, u32 dest_size);
    void ExtractFilePath(LPCSTR src, LPSTR dest, u32 dest_size);
    void ExtractFileExt(LPCSTR src, LPSTR dest, u32 dest_size);
};
