...
void __stdcall PLC_calc3_x86(int& c0, int& c1, int& c2, CRenderDevice& Device, Fvector* P, Fvector& N, light* L,
...
void __stdcall PLC_calc3_SSE(int& c0, int& c1, int& c2, CRenderDevice& Device, Fvector* P, Fvector& N, light* L,
                             float energy, Fvector& O)
{
